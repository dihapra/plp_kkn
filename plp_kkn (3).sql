...
--
-- Host: localhost:3306
-- Generation Time: Jan 04, 2026 at 08:33 PM
...
CREATE TABLE `program_guru` (
  ...
  `pesan_gagal` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_pembayaran` enum('dibayar','belum dibayar') COLLATE utf8mb4_unicode_ci DEFAULT 'belum dibayar',
  `paid_at` datetime DEFAULT NULL,
  `status_perkawinan` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nomor_rekening_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama_rekening_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `buku` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `program_kelompok` (
  `id` int NOT NULL,
  `id_program` int NOT NULL,
  `nama_kelompok` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `program_kelompok_anggota` (
  ...
  `peran` enum('ketua','anggota') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'anggota',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `users` (
  ...
  `role` enum('mahasiswa','guru','dosen','kaprodi','admin','super_admin','kepsek') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `fakultas` varchar(255) DEFAULT NULL,
