...
$route['super-admin/plp/master-data/dosen/delete/(:num)'] = 'superadmincontroller/plp1/master_data_dosen_delete/$1';
...
$route['super-admin/plp/master-data/mahasiswa/options'] = 'superadmincontroller/plp1/master_data_mahasiswa_options';
$route['super-admin/plp/master-data/mahasiswa/store'] = 'superadmincontroller/plp1/master_data_mahasiswa_store';
$route['super-admin/plp/master-data/mahasiswa/delete/(:num)'] = 'superadmincontroller/plp1/master_data_mahasiswa_delete/$1';
...
$route['super-admin/plp/master-data/guru/delete/(:num)'] = 'superadmincontroller/plp1/master_data_guru_delete/$1';
...
$route['super-admin/plp/master-data/kepsek/delete/(:num)'] = 'superadmincontroller/plp1/master_data_kepsek_delete/$1';
...
$route['super-admin/plp/verifikasi/sekolah/detail/(:num)'] = 'superadmincontroller/plp1/verifikasi_sekolah_detail/$1';
$route['super-admin/plp/verifikasi/sekolah/status/(:num)'] = 'superadmincontroller/plp1/verifikasi_sekolah_update_status/$1';
