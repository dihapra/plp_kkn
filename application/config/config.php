...
spl_autoload_register(function ($class) {
    $base_dirs = [
        ...
        APPPATH . 'exports/',
        APPPATH . 'imports/',
        // tambahkan folder lainnya jika perlu
    ];

    foreach ($base_dirs as $base_dir) {
        // Ganti namespace menjadi path: User\CreateUserService → User/CreateUserService.php
        $relative_class = str_replace('\\', DIRECTORY_SEPARATOR, $class);
...
spl_autoload_register(function ($class) {
    $prefixes = [
        'UseCases\\' => APPPATH . 'usecases/',
        'Contexts\\' => APPPATH . 'contexts/',
        'Services\\' => APPPATH . 'services/',
        'Validators\\' => APPPATH . 'validators/',
        'Repositories\\' => APPPATH . 'repositories/',
        // 'Requests\\' => APPPATH . 'requests/',
        'Formatters\\' => APPPATH . 'formatters/',
        'Imports\\' => APPPATH . 'imports/',
        'Exports\\' => APPPATH . 'exports/',
        'Traits\\' => APPPATH . 'traits/',
        // // Tambahkan prefix lain sesuai kebutuhan
    ];

    foreach ($prefixes as $prefix => $base_dir) {
        // Cek apakah class diawali prefix
        $len = strlen($prefix);
        ...
        // Ubah \ menjadi / untuk cari path file
