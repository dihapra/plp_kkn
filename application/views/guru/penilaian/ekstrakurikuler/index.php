...
$endpointMap = [
    'kokurikuler' => [
        'view'  => 'guru/ekstra_view/{student_id}',
        'score' => 'guru/ekstra/{student_id}',
        'edit'  => 'guru/ekstra_edit/{student_id}',
    ],
];
?>
...
<div class="card">
    <div class="card-body">
        <h4 class="mb-3">Penilaian Ekstrakurikuler Per Mahasiswa</h4>
                ...
                <tbody>
                    <?php if (!empty($students)):
                        foreach ($students as $row):
                            ...
                            $has_extra = is_object($row) ? (int)($row->has_extracurricular ?? 0) : (int)($row['has_extracurricular'] ?? 0);
                    ?>
                            <tr>
                                ...
                                <!-- Ekstrakurikuler -->
                                <td>
                                    <?= render_evaluation_status($has_extra, 'Penilaian Ko/Kurikuler & Ekstrakurikuler') ?>
                                </td>
                                <td>
                                    <?= render_evaluation_actions($has_extra, $sid, 'Penilaian Ko/Kurikuler & Ekstrakurikuler', 'kokurikuler', $endpointMap) ?>
                                </td>
                            </tr>
                        <?php endforeach;
                    else: ?>
