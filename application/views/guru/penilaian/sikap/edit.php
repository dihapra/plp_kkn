...
/**
 * View: application/views/guru/penilaian/intra/index.php (adapted for sikap)
...
<div class="container mt-3">
    ...
    <form id="penilaianForm" class="mb-5">
        ...
        <input type="hidden" name="type" value="3"> <!-- Type 3 for Sikap -->
            ...
            try {
                ...
                if (resp.ok) {
                    if (window.Swal) {
                        ...
                        location.href = "<?= base_url('guru/penilaian_sikap') ?>";
                    } else {
