    ...
    <div class="alert alert-info mb-3">
        <div class="d-flex gap-2 align-items-start">
            ...
            <span>
                ...
                pendaftaran mahasiswa sebelum disetujui oleh super admin.
            </span>
        </div>
    </div>
                ...
                <div class="tab-content pt-3">
                    ...
                    <div class="tab-pane fade" id="mahasiswaTrueTabPaneImport" role="tabpanel" aria-labelledby="mahasiswaTrueTabImport">
                        <form id="mahasiswaTrueImportForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <a class="btn btn-outline-light btn-sm" href="<?= base_url('storage/templates/import_mahasiswa_true_template.xlsx') ?>" download>
...
<script>
    $(function () {
        ...
        const table = $('#verifiedStudentTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `${baseUrl}super-admin/datatable/mahasiswa-true`,
                type: 'POST',
                data: function (d) {
                        ...
                        return `
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item text-danger action-delete" href="#" data-id="${id}">Hapus</a></li>
                                </ul>
                            </div>
                        `;
                    }
        ...
        $('#verifiedStudentTable').on('click', '.action-delete', function (e) {
            e.preventDefault();
            const rowData = table.row($(this).closest('tr')).data();
            if (!rowData) {
                return;
            ...
            Swal.fire({
                icon: 'warning',
                title: 'Hapus Data?',
                text: `Data "${rowData.nama}" akan dihapus dari acuan verifikasi.`,
        ...
        async function deleteRow(id) {
            try {
                const response = await fetch(`${baseUrl}super-admin/mahasiswa-true/delete/${id}`, {
                    method: 'POST'
                });
        ...
        $('#mahasiswaTrueForm').on('submit', async function (e) {
            ...
            const endpoint = isUpdate
                ? `${baseUrl}super-admin/mahasiswa-true/update/${id}`
                : `${baseUrl}super-admin/mahasiswa-true/store`;
        ...
        $('#mahasiswaTrueImportForm').on('submit', async function (e) {
            ...
            try {
                const response = await fetch(`${baseUrl}super-admin/mahasiswa-true/import`, {
                    method: 'POST',
                    body: formData
                });
                const result = await response.json();
