...
<script>
    $(function () {
        ...
        const url = baseUrl + 'super-admin/plp/master-data/sekolah/datatable';
        ...
        $('#schoolForm').on('submit', async function (e) {
            ...
            const endpoint = isUpdate
                ? `${baseUrl}super-admin/plp/master-data/sekolah/update/${id}`
                : `${baseUrl}super-admin/plp/master-data/sekolah/store`;
        ...
        $('#schoolImportForm').on('submit', async function (e) {
            ...
            try {
                const response = await fetch(`${baseUrl}super-admin/plp/master-data/sekolah/import`, {
                    method: 'POST',
                    body: formData
                });
                const result = await response.json();
        ...
        $('#dataTable').on('click', '.action-delete', function (e) {
            ...
            Swal.fire({
                ...
                try {
                    const response = await fetch(`${baseUrl}super-admin/plp/master-data/sekolah/delete/${rowData.id}`, {
                        method: 'POST'
                    });
                    const result = await response.json();
                ...
                <div class="tab-content pt-3">
                    ...
                    <div class="tab-pane fade" id="schoolTabPaneImport" role="tabpanel" aria-labelledby="schoolTabImport">
                        <form id="schoolImportForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <a class="btn btn-outline-light btn-sm" href="<?= base_url('storage/templates/import_sekolah_template.xlsx') ?>" download>
