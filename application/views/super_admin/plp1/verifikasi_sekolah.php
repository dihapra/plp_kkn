...
<script>
    $(function () {
        ...
        const table = $('#dataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `${baseUrl}super-admin/plp/verifikasi/sekolah/datatable`,
                type: 'POST',
                data: function (d) {
        ...
        async function fetchVerificationDetail(id) {
            try {
                const response = await fetch(`${baseUrl}super-admin/plp/verifikasi/sekolah/detail/${id}`);
        ...
        async function submitStatusChange(status) {
            setActionButtonsDisabled(true);
            try {
                const response = await fetch(`${baseUrl}super-admin/plp/verifikasi/sekolah/status/${activeMou.id}`, {
                    method: 'POST',
                    headers: {
