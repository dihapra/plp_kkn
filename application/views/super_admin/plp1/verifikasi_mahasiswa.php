    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label fw-semibold mb-1">Aksi Cepat</label>
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-outline-secondary" id="btnResetFilter">
                            <i class="bi bi-arrow-repeat me-1"></i>Reset
                        </button>
                        <button type="button" class="btn btn-primary" id="btnRefreshTable">
...
<script>
    $(function () {
        ...
        $reset.on('click', function () {
            ...
            $status.val('unverified').trigger('change');
        });
