...
<script>
    $(document).ready(function() {
        // Kolom pertemuan yang bisa diubah oleh dosen
        const editableMeetings = [1, 2, 3, 8, 15, 16];
        ...
        const table = $('#dataTable').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: baseUrl + 'dosen/absensi/datatable', // endpoint pivot 16 pertemuan
                type: "POST"
            },
            language: {
        ...
        $('#dataTable').on('change', '.absensi-select', async function() {
            ...
            const url = baseUrl + 'dosen/absensi/simpan';
