        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="feedbackLecturer" rows="3" placeholder="Tuliskan feedback untuk mahasiswa..."></textarea>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $(document).on('click', '.btn-detail-logbook', function() {
            ...
            $.ajax({
                url: '<?= base_url('dosen/logbook/detail/') ?>' + logbookId,
                method: 'GET',
                dataType: 'json',
                ...
                error: function(xhr) {
                    alert('Terjadi kesalahan saat mengambil detail logbook.');
        ...
        $('#saveFeedbackBtn').on('click', function() {
            ...
            const feedback = $('#feedbackLecturer').val();
            const $btn = $(this);
            $btn.prop('disabled', true).text('Menyimpan...');

            $.ajax({
                url: '<?= base_url('dosen/logbook/save-feedback') ?>',
                method: 'POST',
                data: {
