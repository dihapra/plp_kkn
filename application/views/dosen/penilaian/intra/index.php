...
<div class="card">
    <div class="card-body">
        <h4 class="mb-3">Penilaian Asistensi Intrakurikuler Per Mahasiswa</h4>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <?= render_evaluation_status($has_intra, 'Penilaian Asistensi Intrakurikuler') ?>
                                </td>
                                <td>
                                    <?= render_evaluation_actions($has_intra, $sid, 'Penilaian Asistensi Intrakurikuler', 'intrakurikuler', $endpointMap) ?>
                                </td>
                            </tr>
                        <?php endforeach;
                    else: ?>
