...
/**
 * View: application/views/dosen/penilaian/intra/index.php
...
<div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h2 class="mb-0">Penilaian Asistensi Intrakurikuler</h2>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('penilaianForm')?.addEventListener('submit', async (e) => {
            ...
            try {
                const resp = await fetch("<?= base_url('dosen/nilai-intra-ekstra-sikap/save/1') ?>", {
                    method: 'POST',
                    body: fd
                });
