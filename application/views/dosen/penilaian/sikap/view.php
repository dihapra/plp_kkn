...
/**
 * View: application/views/dosen/penilaian/sikap/view.php
 * Diperlukan dari controller:
 *  - $penilaian_sikap : array indikator (AspekPenilaian->penilaian_sikap)
 *  - $student : object student (->id, ->name)
 *  - $scores  : result dari EvaluationCase->get_score_by_student_id(3, $student_id)
 */
...
$persen = $denom > 0 ? round(($total_skor / $denom) * 100, 2) : 0;
?>
<style>
    .table thead th {
...
<div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h2 class="mb-0">Penilaian Sikap Mahasiswa — Lihat</h2>
