...
/**
 * View: application/views/dosen/penilaian/ekstra/edit.php
 * Diperlukan:
 *  - $penilaian_asistensi_kokurikuler : array indikator (AspekPenilaian->penilaian_asistensi_kokurikuler)
 *  - $student : object student (->id, ->name)
 *  - $scores  : result dari EvaluationCase->get_score_by_student_id(2, $student_id)
...
$kokuri       = $penilaian_asistensi_kokurikuler ?? [];
$total_items = count($kokuri);
...
<div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h2 class="mb-0">Edit Penilaian Asistensi Kokurikuler</h2>
                ...
                <table class="table table-bordered align-middle">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th style="min-width:320px">Indikator</th>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('penilaianForm')?.addEventListener('submit', async (e) => {
            ...
            try {
                const resp = await fetch("<?= base_url('dosen/nilai-intra-ekstra-sikap/save/2') ?>", {
                    method: 'POST',
                    body: fd
                });
                ...
                if (resp.ok) {
                    if (window.Swal) {
                        ...
                        location.href = "<?= base_url('dosen/penilaian') ?>";
                    } else {
