...
<div class="card">
    <div class="card-body">
        <h4 class="mb-3">Penilaian Asistensi Ekstrakurikuler Per Mahasiswa</h4>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <?= render_evaluation_actions($has_extra, $sid, 'Penilaian Ko/Kurikuler & Ekstrakurikuler', 'ekstrakurikuler', $endpointMap) ?>
                                </td>
                            </tr>
                        <?php endforeach;
                    else: ?>
