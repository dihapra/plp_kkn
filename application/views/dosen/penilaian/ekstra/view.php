...
/**
 * View: application/views/dosen/penilaian/ekstra/view.php
...
<div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h2 class="mb-0">Penilaian Asistensi Kokurikuler — Lihat</h2>
        <a href="<?= base_url('dosen/penilaian/ekstrakurikuler') ?>" class="btn btn-outline-secondary">← Kembali</a>
    </div>
