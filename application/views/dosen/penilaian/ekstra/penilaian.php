...
/**
 * View: application/views/dosen/penilaian/ekstrakurikuler/index.php
...
<div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h2 class="mb-0">Penilaian Asistensi Kokurikuler</h2>
                ...
                <table class="table table-bordered align-middle">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th style="min-width:220px">Aspek</th>
            ...
            try {
                ...
                if (resp.ok) {
                    if (window.Swal) {
                        ...
                        location.href = "<?= base_url('dosen/penilaian/ekstrakurikuler') ?>";
                    } else {
