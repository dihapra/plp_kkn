<div class="container mt-4">
    <h3 class="mb-4">Aktivitas Mahasiswa</h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deskripsiModalLabel">Deskripsi Aktivitas</h5>
...
<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModalLabel">Edit Aktivitas</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="createForm">
                <div class="modal-body">
...
<script>
    ...
    function initActivityTable() {
        ...
        activityTable = $("#activityTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `${baseUrl}admin/datatable/student_activity`,
                type: "POST",
            },
            language: {
    ...
    $("#activityTable tbody").on("click", ".edit-tugas", async function() {
        ...
        try {
            const response = await fetch(`${baseUrl}admin/aktifitas/mahasiswa/edit/${id}`);
    ...
    $("#editForm").on("submit", async function(e) {
        ...
        try {
            const response = await fetch(`${baseUrl}admin/aktifitas/mahasiswa/update/${id}`, {
                method: "POST",
                body: formData,
            });
    ...
    $("#createForm").on("submit", async function(e) {
        ...
        try {
            const response = await fetch(`${baseUrl}admin/aktifitas/mahasiswa/insert`, {
                method: "POST",
                body: formData,
            });
