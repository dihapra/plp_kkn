<div class="container mt-4">
    <h3 class="mb-4">Aktivitas Dosen</h3>
...
<script>
    ...
    function initActivityTable() {
        ...
        activityTable = $("#activityTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `${baseUrl}admin/datatable/lecture_activity`,
                type: "POST",
            },
            language: {
    ...
    $("#activityTable tbody").on("click", ".edit-tugas", async function() {
        ...
        try {
            const response = await fetch(`${baseUrl}admin/aktifitas/dosen/edit/${id}`);
    ...
    $("#editForm").on("submit", async function(e) {
        ...
        try {
            const response = await fetch(`${baseUrl}admin/aktifitas/dosen/update/${id}`, {
                method: "POST",
                body: formData,
            });
    ...
    $("#createForm").on("submit", async function(e) {
        ...
        try {
            const response = await fetch(`${baseUrl}admin/aktifitas/dosen/insert`, {
                method: "POST",
                body: formData,
            });
